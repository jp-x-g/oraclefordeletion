...
python3 upload.py     			   -i render2.txt -o User:JPxG/Oracle/$YYYY-$MM-test -n "Updating from Toolforge."
...
python3 upload.py     			   -i render2.txt -o User:JPxG/Oracle-test -n "Updating with Toolforge."

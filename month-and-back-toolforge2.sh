...
python3 upload.py     			   -i render2.txt -o User:JPxG/Oracle/$YYYY-$MM -n "Updating from Toolforge."
...
python3 upload.py     			   -i render2.txt -o User:JPxG/Oracle -n "Updating with Toolforge."
